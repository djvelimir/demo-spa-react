        ...
        <div className="flex flex-wrap -m-4">
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
              ...
              <p className="tracking-widest text-green-400 text-xs font-medium title-font">SUBTITLE</p>
              <p className="text-lg text-white font-medium title-font mb-4">Chichen Itza</p>
          ...
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
              ...
              <p className="tracking-widest text-green-400 text-xs font-medium title-font">SUBTITLE</p>
              <p className="text-lg text-white font-medium title-font mb-4">Colosseum Roma</p>
              <p className="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waistcoat. Distillery hexagon disrupt edison bulbche.</p>
            </div>
          </div>
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
              ...
              <p className="tracking-widest text-green-400 text-xs font-medium title-font">SUBTITLE</p>
              <p className="text-lg text-white font-medium title-font mb-4">Great Pyramid of Giza</p>
              <p className="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waistcoat. Distillery hexagon disrupt edison bulbche.</p>
            </div>
          </div>
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
              ...
              <p className="tracking-widest text-green-400 text-xs font-medium title-font">SUBTITLE</p>
              <p className="text-lg text-white font-medium title-font mb-4">San Francisco</p>
              <p className="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waistcoat. Distillery hexagon disrupt edison bulbche.</p>
            </div>
          </div>
        </div>
